...
## --------------------------------
##
## Modified for IceCube environment by John Kelley
## If necessary change the GSL_VERSION to one installed in $I3_PORTS
## 
...
ELSE(WIN32)
  IF(UNIX) 
    ...
    IF(NOT GSL_CONFIG)
       FIND_PROGRAM(GSL_CONFIG gsl-config_${GSL_VERSION}
         ${GSL_CONFIG_PREFER_PATH}
         $ENV{I3_PORTS}/bin
         $ENV{LIB_DIR}/bin
         /usr/local/bin/
    ...
    IF (GSL_CONFIG) 
      ...
      FIND_PATH(GSL_INCLUDE_DIR gsl/gsl_blas.h
                HINTS
                ${GSL_PREFIX}/include/gsl-${GSL_VERSION}
                ${GSL_PREFIX}/include
                )
      MESSAGE("DBG GSL_INCLUDE_DIR ${GSL_INCLUDE_DIR}")
